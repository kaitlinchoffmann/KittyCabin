...
//===========================================
  ...
  // static int Port_to_Server = 11120;
  // static int Port_from_Server = 11121;
  
  static  int Port_to_Server;
  static int Port_from_Server;
  ...
  //**************
   ...
   //String QflagName = "/var/www/ebusiness/b-f19-06/html/files/ClientSocket/f-Qc.dat"; // Lock Flag-File for Question (DATA at Client to send to Server)
   //String QnameAtC = "/var/www/ebusiness/b-f19-06/html/files/ClientSocket/Qc.dat";   // Question-File name (of DATA=QUESTION) at Client to send to Server
   //String QnameAtS = "/var/www/ebusiness/b-f19-06/html/files/ClientSocket/Qs.dat";   // Question-File name (of DATA=QUESTION) to be GIVEN to the Server 

   //String AflagName = "/var/www/ebusiness/b-f19-06/html/files/ClientSocket/f-Ac.dat"; // Lock Flag-File for ANSWER (DATA at Client to send to Server)
   //String AnameAtC = "/var/www/ebusiness/b-f19-06/html/files/ClientSocket/Ac.dat";  // Answer-File name used to write the DATA=ANSWER 
                                // (received at Client site from the Server) 
   //String AnameAtS = "/var/www/ebusiness/b-f19-06/html/files/ClientSocket/As.dat";  // Answer-File name used to ask for at Server site
   ...
   *=============================================*/
   ...
   public Client (String host) throws IOException {
      ...
      Scanner sc = new Scanner(new File("/var/www/ebusiness/b-f19-06/html/files/ClientSocket/necPorts.txt"));
      Port_to_Server = sc.nextInt();
      Port_from_Server = sc.nextInt();
   ...
   //EDITING THIS PART:
//  while(ReadFlag(AflagName)!=0)
//  {
//      System.out.println("...Waiting to take file..flag is at " + AflagName);
//   }
   //EDITING DONE!
