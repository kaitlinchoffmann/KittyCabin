...
//===========================================
   ...
   static int Port_to_Server = 11120; //11020 11140
   static int Port_from_Server = 11121; //11021 11141
  ...
  //**************
   ...
   String QnameAtS = "/var/www/ebusiness/b-f19-06/html/files/ClientSocket/Qs.dat";   //../files/userdata.txt  Question-File name (of DATA=QUESTION) to be GIVEN to the Server 
   ...
   String AnameAtS = "/var/www/ebusiness/b-f19-06/html/files/ClientSocket/As.dat";  ///var/www/ebusiness/b-f19-10/html/files/2/As.dat  ../files/userdata_confirmation.txt Answer-File name used to ask for at Server site
